...
const Blog = () => {
    ...
    return (
        <Container>
            <Row>
                <div className='text-center bg-light border border-warning p-4 rounded shadow m-4'>
                ...
                <div className='text-center bg-light border border-primary p-4 rounded shadow m-4'>
                ...
                <div className='text-center bg-light border border-secondary p-4 rounded shadow m-4'>
                ...
                <div className='text-center bg-light border border-danger p-4 rounded shadow m-4'>
